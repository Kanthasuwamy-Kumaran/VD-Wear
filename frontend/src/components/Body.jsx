                        ...
                        <nav class="navbar" data-navbar>
                            <ul class="navbar-list">
                                ...
                                <li class="navbar-item">
                                    ...
                                    <a class="navbar-link skewBg" data-nav-link>Home</a>
                    ...
                    <div class="section-wrapper">
                                    ...
                                    <li class="scrollbar-item">
                                        <div class="latest-game-card">
                                            ...
                                            <div class="card-content">
                                                ...
                                                <a href="boy" class="card-badge skewBg">coming soon</a>
                        ...
                        <section class="section live-match" id="live" aria-label="live match">
                            <div class="container">
                                ...
                                {/* <video src={demo} width="1000" height="470" controls="controls" autoplay="true" /> */}
